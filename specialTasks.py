...
specialTask(method_special=Tuners.ADMMoptimizerName[1],
            ...
            threads=[128])  # mu= ?, tau = ?
moveALL('ADMMadpA+initial+i100+o100+t128+a=alphas0+mu10+tau2+rep1+1', dtnBase='#')
'''
'''
time.sleep(60)
initialALL()
specialTask(method_special=Tuners.ADMMoptimizerName[2],
            ...
            replicates_special=1,
            threads=[128])  # mu= ?, tau = ?
moveALL('ADMMadpAT+initial+i100+o100+t128+a=alphas0+mu2+tau100+rep1+2', dtnBase='#')
